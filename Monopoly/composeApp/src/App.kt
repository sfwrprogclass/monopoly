...
fun App() {
    ...
    when {
        ...
        playerCount != null && players.isNotEmpty() && !allTokensSelected -> {
        ...
        playerCount != null && players.isNotEmpty() && allTokensSelected && !turnOrderConfirmed -> {
            TurnOrderScreen(
        ...
        turnOrderConfirmed && !showStartingMoneyScreen -> {
